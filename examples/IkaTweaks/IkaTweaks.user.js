...
(function (window) {
    ...
    IkaTweaks.setModule('MoveBuildings', function (modData, modDataSave) {
        ...
        var positionCSS = `
            ...
            #city #locations .position{1}.port .buildingimg{background-image:url(cdn/all/both/img/city/port_r.png)} cdn/all/both/img/city/hafen_r_neu.png
            ...
            #city .animated #locations .position{1}.port.busy .buildingimg{background-image:url(cdn/all/both/img/city/hafen_r_neu.png)}
            #city .animated #locations .position{2}.port.busy .buildingimg{background:url(cdn/all/both/img/city/port_l.png) 5px 0px}
        `;
